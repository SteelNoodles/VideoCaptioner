...
# 评论字幕位置常量
COMMENT_POSITION_LEFT_TOP = "left_top"
COMMENT_POSITION_RIGHT_TOP = "right_top"
COMMENT_POSITION_LEFT_BOTTOM = "left_bottom"
COMMENT_POSITION_RIGHT_BOTTOM = "right_bottom"
